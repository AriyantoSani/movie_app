...
// in movie_app/test/controller/movie_list_controller_test.dart.
...
import 'package:movie_app/domain/usecases/get_movies.dart' as _i4;
import 'package:movie_app/domain/usecases/search_movies.dart' as _i8;
...
class MockGetMovies extends _i1.Mock implements _i4.GetMovies {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Movie>>> call(int? page) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [page],
